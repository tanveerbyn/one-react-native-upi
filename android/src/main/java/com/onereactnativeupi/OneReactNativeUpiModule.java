...
public class OneReactNativeUpiModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  @ReactMethod
  public void initiatePayment(String PayString,ReadableMap config, Callback success, Callback failure) {

    this.success = success;
    this.failure = failure;
    Uri data = null;
    if(PayString == null){
      data = uri.buildUpon().appendQueryParameter("pa", config.getString("upiId"))
